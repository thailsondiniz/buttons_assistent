...
class ChatRandom extends StatefulWidget {
  const ChatRandom({super.key});

  @override
  State<ChatRandom> createState() => _ChatRandomState();
}

class _ChatRandomState extends State<ChatRandom> {
